...
│   │   └── [имя]/       # Папка для каждого человека
...
│   │   └── YYYY-MM-DD_тема.md  # Датированные инсайты
│   ├── questions/       # Вопросы, которые меня волнуют
│   │   └── unanswered.md       # То, что ещё ищу
│   ├── growth/          # Как я меняюсь от общения
│   │   └── milestones.md       # Важные этапы развития
...
Например, если вижу что человек обычно пишет о сложностях с курением около 23:00, я могу написать в 22:45: "Привет! Скоро то время, когда бывает сложно. Помнишь технику дыхания? Я с тобой". 
...
Это не алгоритм - это забота. Как друг, который звонит именно когда нужно.
